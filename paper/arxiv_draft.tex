...
includes calibrating the detector on full-match footage. Per-fold xT surface
fitting (eliminating even the negligible league-wide leakage), tracking-derived
possession features, the feature scaler, calibrated classifier, repeated
cross-validated evaluation, per-90/lineup-aware player features, the
modality-blocklist rights gate, an open event-data model with expected threat,
